// The truetype library processes TrueType files:
//  - parse files
...
func (font *FontInfo) GetGlyphHMetrics(glyphIndex int) (int, int) {
	...
	return int(int16(u16(font.data, font.hmtx+4*(numOfLongHorMetrics-1)))),
		int(int16(u16(font.data, font.hmtx+4*numOfLongHorMetrics+2*(glyphIndex-numOfLongHorMetrics))))
}
